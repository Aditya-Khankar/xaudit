...
Detects repetitive behavior patterns (infinite loops) using Lempel-Ziv
Complexity. A rational agent progresses towards a goal; cyclic
redundancy indicates failure to break out of a loop.

Method: LZ76 substring counting with n/log2(n) normalization.
...
class CyclicRedundancyDetector(BaseDetector):
