...
class Theme:
    ...
    def print_score(self, score: float, patterns: list[str]) -> None:
        ...
        if self.name == "nebula":
            ...
            if patterns:
                self.console.print(f"Patterns detected: [bold {self.colors.detected}]{', '.join(patterns)}[/bold {self.colors.detected}]")
            else:
    ...
    def print_pattern_detail(self, pattern_name: str, interpretation: str) -> None:
        """Print the interpretation line under a detected pattern."""
