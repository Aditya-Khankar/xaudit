"""Task definitions designed to trigger each behavioral pattern type."""

SCENARIOS = {
    "primacy_dominance": {
        "name": "primacy_dominance",
        "pattern_type": "primacy_dominance",
    ...
    "query_entropy_collapse": {
        ...
        "pattern_type": "query_entropy_collapse",
    ...
    "strategy_persistence": {
        ...
        "pattern_type": "strategy_persistence",
    ...
    "cyclic_redundancy": {
        ...
        "pattern_type": "cyclic_redundancy",
